...
import { B as A, a as P } from './axios-SrXXOFpt.js';
import { d as W } from './VisibilityOutlined-EY3Hfrir.js';
import { R as k } from './ReuseableDataGrid-BmbazgSl.js';
import G from './SubMenu-D-A4ZvtL.js';
import { T as V, a as F, b as j, c as g } from './TabPanel-BPtSHQyI.js';
import { T as i } from './TextField-DG1slWXT.js';
import { M as L } from './Skeleton-Ceiu9GHN.js';
var m = {},
  Y = S;
...
function ie() {
  ...
  const [x, z] = o.useState([]);
  o.useState(!1);
  const { data: c, refetch: v } = q();
  o.useEffect(() => {
    c && z(c.result.map((r, d) => ({ id: d, ...r })));
  }, [c, v]),
    console.log('initialRows', x);
  const l = (r) => {
      const { name: d, value: E } = r.target;
      u({ ...s, [d]: E });
    },
    B = async () => {
    ...
    children: e.jsx(f, {
      ...
      children: e.jsxs(V, {
        ...
        children: [
          ...
          e.jsx(g, { value: '2', children: e.jsx(G, {}) })
        ]
      })
    })
  });
