...
import { B as O, a as B } from './axios-SrXXOFpt.js';
import { d as D } from './VisibilityOutlined-EY3Hfrir.js';
import { R as E } from './ReuseableDataGrid-BmbazgSl.js';
...
function q() {
  ...
  const o = (r) => {
    ...
    I = async () => {
      ...
      try {
        const r = await B.post('https://gecxc.com:449/api/Role/SaveRole', a);
