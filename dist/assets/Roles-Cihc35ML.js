...
import { B as O, a as B } from './axios-sajpI7HX.js';
import { d as D, R as E } from './ReuseableDataGrid-D6nBr4pK.js';
...
function q() {
  ...
  const o = (r) => {
    ...
    I = async () => {
      ...
      try {
        const r = await B.post('https://gecxc.com:4041/api/Role/SaveRole', a);
