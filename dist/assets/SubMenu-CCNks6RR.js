...
import { B as D, a as z } from './axios-BAxkGnGK.js';
import { d as L } from './VisibilityOutlined-7xGDXOA6.js';
import { R as U } from './ReuseableDataGrid-Bo304H0A.js';
import { T as o } from './TextField-CsNxJIZ0.js';
import { M as b } from './Skeleton-C1EQF4m0.js';
function A() {
  const { user: d } = O(),
    [e, I] = t.useState([]),
    [R, x] = t.useState(!1),
  ...
  const l = (n) => {
    ...
    y = async () => {
      ...
      try {
        const n = await z.post(
          'http://100.42.177.77:81/api/Menu/SaveSubMenu',
          r
        );
