...
import { B as L, a as T, I as E } from './axios-SrXXOFpt.js';
import { d as Q, a as V } from './PersonAddAlt1Outlined-DIFSZ7au.js';
import { d as G } from './VisibilityOutlined-EY3Hfrir.js';
import {
  R as F,
  D as _,
  a as $,
...
import { T as i } from './TextField-DG1slWXT.js';
import { M as w } from './Skeleton-Ceiu9GHN.js';
const Z = ({
    userData: d,
    ...
    const f = [
      ...
      O = `assignedUserRoles${new Date().toISOString()}`;
    return e.jsxs(W, {
...
function ie() {
  ...
  l.useState(!1);
  const { data: p, refetch: x } = P();
  l.useEffect(() => {
    p && o(p.result.map((n, f) => ({ id: f, ...n })));
  }, [p, x]),
    console.log('initialRows', I);
  const c = (n) => {
      const { name: f, value: O } = n.target;
      g({ ...s, [f]: O });
    },
    C = async () => {
      console.log('formData', s);
      try {
        const n = await T.post('https://gecxc.com:449/api/Users/SaveUsers', s);
                ...
                children: [
                  ...
                  e.jsxs(_, {
                    ...
                    children: [
                      ...
                      e.jsxs(J, {
                        children: [
                          e.jsx(K, { id: 'alert-dialog-slide-description' }),
