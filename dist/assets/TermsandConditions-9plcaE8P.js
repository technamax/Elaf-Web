...
import { B as W, a as Y } from './axios-BAxkGnGK.js';
import { d as Z } from './AddCircleOutlineOutlined-rt-o6Sk6.js';
import { d as ee, a as te } from './AssignmentOutlined-JXC2IVJR.js';
import { d as G } from './VisibilityOutlined-7xGDXOA6.js';
import { R as H, u as se, D as ae } from './ReuseableDataGrid-Bo304H0A.js';
import { T as f } from './TextField-CsNxJIZ0.js';
import { M as C } from './Skeleton-C1EQF4m0.js';
import { T as re, a as de, b as M, c as k } from './TabPanel-CcXhfPsy.js';
const oe = () => {
    const { user: a } = L(),
      [t, T] = s.useState([]),
      [F, x] = s.useState(!1),
    ...
    s.useEffect(() => {
      p({
        ...
        appId: (t == null ? void 0 : t.appId) || a.appId,
        createdOn:
          (t == null ? void 0 : t.createdOn) || new Date().toISOString(),
        createdBy: (t == null ? void 0 : t.createdBy) || a.empId,
        lastUpdatedOn: new Date().toISOString(),
        LastUpdatedBy: a.empId
      });
    }, [t]);
    const [u, O] = s.useState([]);
    s.useState(!1);
    const { data: h, refetch: S } = z(),
      { data: g, refetch: m } = $(l.categoryId, { skip: !l.categoryId }),
      [I, D] = s.useState([]);
    s.useEffect(() => {
      g && O(g.result.map((r, c) => ({ id: c + 1, ...r })));
    }, [g, m]),
      s.useEffect(() => {
        h && D(h.result.map((r, c) => ({ id: c, ...r })));
      }, [h, S]),
      console.log('initialRows', u);
    const y = (r) => {
        const { name: c, value: N } = r.target;
        p({ ...l, [c]: N });
      },
      B = async () => {
              ...
              children: [
                e.jsx(n, {
                  ...
                  children: e.jsx(f, {
                    ...
                    children: I.map((r) =>
                      e.jsx(
                        C,
                        { value: r.categoryId, children: r.description },
                        r.categoryId
                      )
                    )
                  })
                ...
                e.jsx(n, {
                  ...
                  children: e.jsx(f, {
                    ...
                    size: 'small',
                    children: i.map((r) =>
                      e.jsx(C, { value: r.value, children: r.label }, r.value)
                    )
                  })
                }),
                e.jsx(n, {
  ...
  ne = () => {
    ...
    const [h, S] = s.useState([]);
    s.useState(!1);
    const { data: g } = X(),
      { data: m } = z(),
      { data: I, refetch: D } = $(i.categoryId, { skip: !i.categoryId }),
      [y, B] = s.useState([]),
      [o, r] = s.useState([]);
    s.useEffect(() => {
      if (g) {
      ...
      s.useEffect(() => {
        I && S(I.result.map((d, j) => ({ id: j + 1, ...d })));
      }, [I]),
      s.useEffect(() => {
        m && B(m.result.map((d, j) => ({ id: j, ...d })));
      }, [m]),
      console.log('initialRows', h);
    const c = (d) => {
        const { name: j, value: A } = d.target;
        u({ ...i, [j]: A });
      },
      N = async () => {
    ...
    const V = [
      ...
      Q = s.useCallback(
        (d) => {
          ...
          const A = d
            .map((E) => {
              const R = v.current.getRow(E);
              return console.log('rowData', R), R ? R.tcId : null;
            })
            .filter((E) => E !== null)
            .map((E) => ({
              assignDetId: 0,
                ...
                children: [
                  ...
                  e.jsx(n, {
                    ...
                    children: e.jsx(f, {
                      ...
                      size: 'small',
                      children: O.map((d) =>
                        e.jsx(C, { value: d.value, children: d.label }, d.value)
                      )
                    })
                  }),
                  e.jsxs(n, {
  ...
  fe = () => {
    ...
    const [S, g] = s.useState([]);
    s.useState(!1);
    const { data: m, refetch: I } = z();
    s.useEffect(() => {
      m && g(m.result.map((o, r) => ({ id: r + 1, ...o })));
    }, [m, I]),
      console.log('initialRows', S);
    const D = (o) => {
        const { name: r, value: c } = o.target;
        p({ ...l, [r]: c });
      },
      y = async () => {
        console.log('formData', l);
      ...
      children: e.jsx(U, {
        ...
        children: e.jsxs(re, {
          ...
          children: [
                  ...
                  e.jsx(M, {
                    ...
                    sx: (o) => ({
                      '& .MuiTouchRipple-child': {
                        backgroundColor: `${o.palette.primary.main} !important`
                      }
                    })
                  }),
                  e.jsx(M, {
            ...
            e.jsx(k, { value: '2', children: e.jsx(oe, {}) }),
            e.jsx(k, { value: '3', children: e.jsx(ne, {}) })
          ]
        })
      })
    });
