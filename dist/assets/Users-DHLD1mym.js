...
import { B as L, a as T, I as E } from './axios-sajpI7HX.js';
import { d as Q } from './Close-D_kvijF0.js';
import {
  d as G,
  R as k,
  D as V,
...
import { d as K } from './PersonAddAlt1Outlined-DIBwwKNd.js';
import { T as i } from './TextField-47SmC6NA.js';
import { M as w } from './Skeleton-BTBpQPPV.js';
...
function me() {
  ...
  const c = (n) => {
    ...
    C = async () => {
      ...
      try {
        const n = await T.post('https://gecxc.com:4041/api/Users/SaveUsers', s);
