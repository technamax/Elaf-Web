...
import { B as he, a as ve, I as Be } from './axios-SrXXOFpt.js';
import {
  d as pt,
  c as Ze,
  A as mt,
  ...
  b as Ut,
  F as Ht
} from './Fabrication-BEZufaAZ.js';
import { d as Ee } from './VisibilityOutlined-EY3Hfrir.js';
import {
  A as Je,
  R as Ue,
  F as bt,
  ...
  f as dt,
  g as Ge
} from './ReuseableDataGrid-BmbazgSl.js';
import { d as st, a as lt } from './PersonAddAlt1Outlined-DIFSZ7au.js';
import { T as i, P as Et } from './TextField-DG1slWXT.js';
...
var ft = (it.default = void 0),
  Xt = Yt(Mt()),
  _t = e;
ft = it.default = (0, Xt.default)(
  (0, _t.jsx)('path', {
...
const Vt =
  ...
  Jt = ({
    ...
    const U = (c) => {
      const { name: O, value: f } = c.target;
      z({ ...m, [O]: f }),
        z((q) => {
          const x = { ...q, [O]: f };
          if (O === 'assignedQty' || O === 'remainingQty') {
            const de = x.assignedQty,
              ne = x.remainingQty;
            de > ne
              ? p((le) => ({
                  ...le,
          ...
          children: [
            ...
            e.jsx(o, {
              ...
              children: e.jsx(Ue, {
                ...
                setInitialData: r,
                deleteApi:
                  'https://gecxc.com:449/api/DyeingPrinting/DeleteDyeingPrintingDetailByDetId?dpIdDet=',
                deleteBy: 'dpIdDet',
                refetch: D
              })
            })
  ...
  Zt = ({
    ...
    a.useEffect(() => {
      const M = () => {
          const L = parseFloat(x.repeats) || 0,
            A = parseFloat(x.itemsPerRepeat) || 0;
          return (L * A).toFixed(2);
        },
        H = () => {
          const L = parseFloat(x.threadStiches) || 0,
            A = parseFloat(x.threadRate) || 0,
            re = parseFloat(x.noOfHeadsName) || 0,
            be = parseFloat(x.repeats) || 0;
          return ((L / 1e3) * (A * be * re)).toFixed(2);
        },
        T = () => {
          const L = parseFloat(x.tillaStiches) || 0,
            A = parseFloat(x.tilaRate) || 0,
            re = parseFloat(x.noOfHeadsName) || 0,
            be = parseFloat(x.repeats) || 0;
          return ((L / 1e3) * (A * be * re)).toFixed(2);
        },
        X = () => {
          const L = parseFloat(x.sequence) || 0,
            A = parseFloat(x.sequenceRate) || 0,
            re = parseFloat(x.noOfHeadsName) || 0,
            be = parseFloat(x.repeats) || 0;
          return ((L / 1e3) * (A * be * re)).toFixed(2);
        },
        oe = () => {
          const L = parseFloat(x.repeats) || 0,
            A = parseFloat(x.noOfHeadsName) || 0,
            re = parseFloat(x.solvingLayers) || 0;
          return (((L * A * 13) / 39.37) * re).toFixed(2);
        },
        $ = () => {
          const L = parseFloat(x.solvingInMeters) || 0,
            A = parseFloat(x.solvingRate) || 0;
          return (L * A).toFixed(2);
        },
        ue = () => {
          const L = parseFloat(x.threadAmount) || 0,
            A = parseFloat(x.tilaAmount) || 0,
            re = parseFloat(x.sequenceAmount) || 0,
            be = parseFloat(x.solvingAmount) || 0;
          return (L + A + re + be).toFixed(2);
        },
        _ = () => {
          const L = parseFloat(String(x.totalAmount).replace(/,/g, '')) || 0,
            A = parseFloat(x.requiredPcs) || 0;
          return (L / A).toFixed(2);
        },
        j = ue(),
        Q = _();
      ...
      a.useEffect(() => {
        if (f === 'assignedQty') {
          const M = () => {
            const H = parseFloat(x.assignedQty) || 0,
              T = parseFloat(x.availableQty) || 0,
              X = parseFloat(x.totalPcs) || 0;
            return Math.round(H * (X / T));
          };
          F((H) => ({ ...H, requiredPcs: M() }));
        } else if (f === 'requiredPcs') {
          const M = () => {
            const H = parseFloat(x.requiredPcs) || 0,
              T = parseFloat(x.availableQty) || 0,
              X = parseFloat(x.totalPcs) || 0;
            ...
            children: [
              ...
              e.jsx(o, {
                ...
                children: e.jsx(Ue, {
                  ...
                  setInitialData: P,
                  deleteApi:
                    'https://gecxc.com:449/api/Embroidery/DeleteEmbroideryDetailsByDetId?embroideryDetId=',
  ...
  Kt = ({ initialValues: h }) => {
    ...
    const _ = (I) => {
        ...
        if (G === 'collectionId')
          ...
          const K = f.find((Ie) => Ie.designId === parseInt(pe));
          X([]),
            te(!0),
            y({
              ...r,
          ...
          const K = x.find((Ie) => Ie.batchNo === pe);
          y({
            ...r,
            batchNo: pe,
              ...
              children: e.jsxs(o, {
                ...
                children: [
                  ...
                  e.jsx(Ue, {
                    ...
                    setInitialData: v,
                    deleteApi:
                      'https://gecxc.com:449/api/Embroidery/DeleteEmbroideryById?embroideryId=',
  ...
  $t = ({ setInitialValues: h, initialValues: S }) => {
      ...
      a.useEffect(() => {
        if (D) {
          ...
          ne(n.componentList),
            ...
            T(n.noOfHeadsList),
            M(n.uomList),
            f(n.planningTypeProcessList),
            x(n.operatingMachineList);
        }
      }, [D]),
      a.useEffect(() => {
        const n = async (b) => {
          try {
            const R = await ve.get(
              `https://gecxc.com:449/api/PrePlanning/GetPrePlanningHeaderByDesignId?designId=${b}`
            );
    ...
    console.log('batchList:', X);
    const s =
        'https://gecxc.com:449/api/PrePlanning/DeletePreplanningByPlanningId?PlanningId=',
      k = (n, b) => {
        _(!ue);
      };
    return e.jsxs(e.Fragment, {
  ...
  oo = ({ initialValues: h }) => {
    ...
    const T = (d) => {
      ...
      if (s === 'collectionId')
        ...
        f.find((n) => n.fabricId === k),
          console.log('Selected Fabric:', f),
          l({ ...v, fabricId: k });
      else if (s === 'ColorId') {
        const n = xe.find((b) => b.colorId === k.colorId);
        l({
          ...v,
          ColorId: k.colorId,
          color: n.color,
              ...
              children: [
                ...
                e.jsx(o, {
                  ...
                  children: e.jsx(Gt, {
                    ...
                    value: xe.find((d) => d.colorId === v.colorId) || null,
                    onChange: (d, s) => {
                      l((k) => ({
                        ...k,
                        colorId: s ? s.colorId : '',
              ...
              children: e.jsxs(o, {
                ...
                children: [
                  e.jsx(Ue, {
                    ...
                    setInitialData: t,
                    deleteApi:
                      'https://gecxc.com:449/api/DyeingPrinting/DeleteDyeingPrintingById?DPId=',
                    deleteBy: 'dpId',
                    refetch: Y,
    ...
    const Q = (s) => {
      ...
      L = (s) => {
        ...
        if (k === 'collectionId')
          ...
          const b = f.find((R) => R.designId === parseInt(n));
          $([]),
            C(!0),
            g({
              ...l,
            ...
            e.jsx(o, {
              ...
              children: e.jsx(o, {
                ...
                children: e.jsx(Ue, {
                  ...
                  setInitialData: v,
                  deleteApi:
                    'https://gecxc.com:449/api/Schiffli/DeleteSchiffiById?schiffiId=',
    ...
    a.useEffect(() => {
      const w = () => {
        const O = parseFloat(P.quantity) || 0,
          f = parseFloat(P.ratePerPcs) || 0;
        return (O * f).toFixed(2);
      };
      m((O) => ({ ...O, totalAmount: w() }));
      const c = () => {
        const O = parseFloat(P.totalAmount) || 0,
          f = parseFloat(P.poPcs) || 0;
        return (O / f).toFixed(2);
      };
        ...
        e.jsx(o, {
          ...
          children: e.jsx(o, {
            ...
            children: e.jsx(Ue, {
              ...
              setInitialData: E,
              deleteApi:
                'https://gecxc.com:449/api/AdditionalProcess/DeleteAdditionalProcessDetails?apdId=',
              ...
              children: e.jsxs(o, {
                ...
                children: [
                  e.jsx(Ue, {
                    ...
                    setInitialData: v,
                    deleteApi:
                      'https://gecxc.com:449/api/AdditionalProcess/DeleteAdditionalProcess?adId=',
...
function co({ initialValues: h }) {
  ...
  const u = async (c) => {
    const { name: O, value: f } = c.target;
    if (
      (console.log(`Updating ${O} to ${f}`),
      z({ ...m, [O]: f }),
      O === 'collectionId')
    ) {
      const q = y.find((x) => x.collectionId === f);
      q && z((x) => ({ ...x, poPcs: q.poPcs }));
    }
  };
  a.useEffect(() => {
    const c = () => {
      const f = parseFloat(m.qty) || 0,
        q = parseFloat(m.rate) || 0;
      return (f * q).toFixed(2);
    };
    z((f) => ({ ...f, totalAmount: c() }));
    const O = () => {
      const f = parseFloat(m.poPcs) || 0,
        q = parseFloat(m.totalAmount) || 0;
      return (f / q).toFixed(2);
    };
    z((f) => ({ ...f, costperPiece: O() }));
    ...
    W = a.useCallback(async () => {
      try {
        const c = await ve.get(
          `https://gecxc.com:449/api/AdditionalServices/GetAdditionalServicesListByCollectionId?collectionId=${m.collectionId}`
        );
        Array.isArray(c.data.result)
          ? (V(!1), Z(c.data.result.map((O, f) => ({ id: f + 1, ...O }))))
          : (console.error(
  ...
  a.useEffect(() => {
    const c = D.reduce((O, f) => O + (f.totalAmount ?? 0), 0).toFixed(2);
    ...
    const c = async (j) => {
      ...
      try {
        const Q = await ve.get(
          `https://gecxc.com:449/api/PrePlanning/GetPrePlanningSummaryByBatchId?planningHeaderId=${j}`
        );
...
function vo() {
  ...
  const P = (f) => {
    ...
    Z = () => {
      let f = V;
      D(h) && ((f = new Set(f.values())), f.delete(h)), S((q) => q + 1), te(f);
    },
    W = () => {
      S((f) => f - 1);
    },
    ...
    c = async () => {
      ...
      try {
        const f = await ve.get(
          `https://gecxc.com:449/api/Common/SaveLookUp?lookupDomain=${J.lookUpDomain}&LookUpName=${J.lookUpName}&appId=1`
        );
        return (
          console.log('Form data saved:', f.data),
    ...
    O = (f) => {
      w({ ...J, [f.target.name]: f.target.value });
    };
  return (
    a.useEffect(() => {
      (async () => {
                        ...
                        children: e.jsx(i, {
                          ...
                          children: v.map((f) =>
                            e.jsx(
                              B,
                              {
                                value: f.lookUpDomain,
                                children: f.lookUpDomain
                              },
                              f.lookUpDomain
                            )
                          )
