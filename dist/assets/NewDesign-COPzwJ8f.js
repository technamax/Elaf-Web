...
import { I as de, B as M, a as j } from './axios-SrXXOFpt.js';
import { d as ce, a as ue } from './AddCircle-CI1h8bkx.js';
import { d as ge } from './LoopOutlined-CqBXh8vt.js';
import './dayjs.min-DO4_1a-m.js';
import { R } from './ReuseableDataGrid-BmbazgSl.js';
import { d as me } from './VisibilityOutlined-EY3Hfrir.js';
import { T as pe, a as he, b as U, c as F } from './TabPanel-BPtSHQyI.js';
import { T as c } from './TextField-DG1slWXT.js';
import { M as S } from './Skeleton-Ceiu9GHN.js';
const ke = () => {
  const { user: i } = ae(),
    [E, z] = r.useState(!0),
    [a, G] = r.useState([]),
  ...
  const u = (t) => {
    ...
    if (s === 'collectionId') {
      const p = v.find((D) => D.collectionId === parseInt(l));
      W(l),
        m({
          ...n,
          collectionId: l,
  ...
  const q =
      'https://gecxc.com:449/api/DesignRegistration/DeleteDesignById?designId=',
    [J, K] = r.useState([]),
    Z = async () => {
      try {
        const t = await j.get(
          `https://gecxc.com:449/api/DesignRegistration/GetDesignListByDateOfPlanning?appId=1&startDate=${d.searchPlanningDateFrom}&endDate=${d.searchPlanningDateTo}`
        );
