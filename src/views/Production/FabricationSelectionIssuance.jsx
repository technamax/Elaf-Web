  ...
  const GetFabricForProductionByCollectionId = async (appId, collectionId) => {
    ...
    try {
      const response = await axios.get(
        `http://100.42.177.77:8091/api/Production/GetFabricForProductionByCollectionId?appId=${appId}&collectionid=${collectionId}`
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://100.42.177.77:8091/api/Production/StartProductionProcess',
        formData
      );
