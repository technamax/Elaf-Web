...
const ShrinkageWastageConfiguration = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://100.42.177.77:8091/api/Configurations/SaveShrinkageWastageConfiguration',
        formData
      );
  ...
  const deleteApi = `http://100.42.177.77:8091/api/Configurations/DeleteShrinkageWastageConfigurationById?configurationId=`;
  return (
