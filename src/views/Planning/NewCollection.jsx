...
const NewCollection = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.post(
        'http://100.42.177.77:8091/api/CollectionRegistration/SaveCollection',
        formData
      );
  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(
        `http://100.42.177.77:8091/api/CollectionRegistration/GetCollectionListByPlanningDate?startDate=${searchData.searchPlanningDateFrom}&endDate=${searchData.searchPlanningDateTo}&appId=1`
      );
  ...
  const deleteApi =
    'http://100.42.177.77:8091/api/CollectionRegistration/DeleteCollectionByCollectionId?collectionId=';
  // const editAPi =
  //   'http://100.42.177.77:8091/api/CollectionRegistration/SaveCollection';
  const handleReset = () => {
    setFormData({
