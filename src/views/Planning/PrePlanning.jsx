...
const PrePlanning = ({ setInitialValues, initialValues }) => {
  ...
  useEffect(() => {
    const GetPrePlanningHeaderByDesignId = async (id) => {
      try {
        const response = await axios.get(
          `http://100.42.177.77:8091/api/PrePlanning/GetPrePlanningHeaderByDesignId?designId=${id}`
        );
    ...
    //   try {
    //     const response = await axios.get(
    //       `http://100.42.177.77:8091/api/PrePlanning/GetPrePlanningByPlanningHeaderId?planningHeaderId=${id}`
    //     );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://100.42.177.77:8091/api/PrePlanning/SavePrePlanning',
        cleanedFormData
      );
  ...
  const deleteApi = `http://100.42.177.77:8091/api/PrePlanning/DeletePreplanningByPlanningId?PlanningId=`;
