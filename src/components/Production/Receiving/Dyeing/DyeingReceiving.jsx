...
const DyeingReceiving = () => {
  ...
  //       `http://100.42.177.77:86/api/Receiving/GetIssuanceByPoIdAndOGPNumber?poId=${formData.poId}&issuanceId=${formData.issuanceId}`
  //     );
  ...
  const fetchData = async () => {
    try {
      // Make the API call
      const response = await axios.get(
        `http://100.42.177.77:86/api/Receiving/GetIssuanceByPoIdAndOGPNumber?poId=${formData.poId}`
      );
      console.log('Save response:', response.data);
