...
//       const response = await axios.get('https://gecxc.com:4041/api/Menu/GetMainMenuById?id=1');
...
//     try {
//       console.log("Fetching data...");
//       const response = await axios.get('https://gecxc.com:4041/api/Menu/GetMainMenuList');
//       console.log("Data fetched:", response.data);
