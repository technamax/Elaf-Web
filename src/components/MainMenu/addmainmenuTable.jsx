...
//       const response = await axios.get('http://100.42.177.77:86/api/Menu/GetMainMenuById?id=1');
...
//     try {
//       console.log("Fetching data...");
//       const response = await axios.get('http://100.42.177.77:86/api/Menu/GetMainMenuList');
//       console.log("Data fetched:", response.data);
