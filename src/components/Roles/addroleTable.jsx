...
export default function AddRoleTable() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const response = await axios.get(
        `http://100.42.177.77:8091/api/Role/GetRoleById?id=1`
      );
  ...
  const fetchData2 = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        'http://100.42.177.77:8091/api/Role/GetRoleList?appId=1'
      );
  ...
  const fetchData3 = useCallback(async () => {
    try {
      console.log('Fetching data...');
      const response = await axios.get(
        'http://100.42.177.77:8091/api/Role/DeleteRoleById?id=1'
      );
      console.log('Data fetched:', response.data);
